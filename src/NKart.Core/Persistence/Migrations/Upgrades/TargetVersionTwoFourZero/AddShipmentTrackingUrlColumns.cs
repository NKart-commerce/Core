...
namespace NKart.Core.Persistence.Migrations.Upgrades.TargetVersionTwoFourZero
{
    using System.Linq;

    using NKart.Core.Configuration;
    using NKart.Core.Persistence.Migrations.Upgrades.TargetVersionTwoZeroZero;
