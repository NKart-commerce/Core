...
using NKart.FastTrack.Models.Membership;

namespace NKart.FastTrack.Controllers.Membership
{
    using System;
    ...
    using NKart.Core;
    using NKart.Core.Gateways.Notification.Smtp;
    ...
    using LoginModel = Models.Membership.LoginModel;
