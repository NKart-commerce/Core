...
namespace NKart.Web.Store.Controllers.Payment
{
    using System;
    using System.Linq;
    ...
    public class PayPalExpressPaymentController : CheckoutPaymentControllerBase<StorePaymentModel>
    {
        ...
        {
            var provider = GatewayContext.Payment.GetProviderByKey(NKart.Providers.Constants.PayPal.GatewayProviderSettingsKey);
