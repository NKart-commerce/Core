...
namespace NKart.Web.Store.Factories
{
        ...
        where TPaymentModel : BraintreePaymentModel, new()
    {
        ...
        public BraintreePaymentModelFactory()
        {
            ...
            var provider = (BraintreePaymentGatewayProvider)MerchelloContext.Current.Gateways.Payment.GetProviderByKey(NKart.Providers.Constants.Braintree.GatewayProviderSettingsKey);
