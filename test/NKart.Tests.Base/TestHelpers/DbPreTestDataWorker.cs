...
namespace NKart.Tests.Base.TestHelpers
{
    ...
    public class DbPreTestDataWorker : IDisposable
    {
        ...
        public DbPreTestDataWorker()
        {
            ...
            WarehouseCatalog = new WarehouseCatalog(global::NKart.Core.Constants.Warehouse.DefaultWarehouseKey)
            {
                Key = global::NKart.Core.Constants.Warehouse.DefaultWarehouseCatalogKey
            }; 
        }
        ...
        public void DeleteAllShipCountries()
        {
            ...
            foreach (var country in shipCountries.Where(x => !x.CountryCode.Equals(global::NKart.Core.Constants.CountryCodes.EverywhereElse)))
            {
